...
def predict(latitude_input,longitude_input,date):
    ...
    predict_days=abs((datetime.strptime('2021-04-04',"%Y-%m-%d")-datetime.strptime(date,"%Y-%m-%d")).days)
    ...
    end_date=L3_data1.variables['time'].units[14:18]+'-04-04'
    ...
    #df.to_csv(r"C:\Users\HP\.spyder-py3\data\days_combined.csv")
